...
createRestaurantHTML = (restaurant) => {
  ...
  image.alt = "Image for "+name.innerHTML;
  image.setAttribute("aria-label","restaurant image for " + name.innerHTML);

  name.setAttribute("tabindex",0);
  
  name.setAttribute("aria-label", name.innerHTML + " heading");
  li.append(image);
  li.append(name);
